...
class TSPData:
    ...
    def build_distance_lists(self):
        ...
        backup = TSPData.read_from_file("./../data/my_tsp2")
    ...
    def build_distance_matrix(self, aco):
        ...
        for i in range(number_of_product):
            ...
            for j in range(number_of_product):
                ...
                shortest_route, shortest_each_gen = aco.find_shortest_route(PathSpecification(start, end))
    ...
    def build_start_to_products(self, aco):
        ...
        for i in range(len(self.product_locations)):
            print("\n Product", i, "start\n")
            start_to_products.append(aco.find_shortest_route(PathSpecification(start, self.product_locations[i]))[0])
    ...
    def build_products_to_end(self, aco):
        ...
        for i in range(len(self.product_locations)):
            print("\n Product", i, "end\n")
            products_to_end.append(aco.find_shortest_route(PathSpecification(self.product_locations[i], end))[0])
